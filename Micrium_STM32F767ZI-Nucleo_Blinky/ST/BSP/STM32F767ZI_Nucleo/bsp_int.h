...
#define  INT_ID_MAX_NBR              110u                       /* Max. number of ext. interrupt sources. (Check MCU RM)*/

                                                                /* 126 VTOR entries; next power of 2 is 256             */
...
typedef  enum  bsp_int_id {
    ...
    INT_ID_OTG_FS             =  67u,                           /* USB OTG FS Interrupt                                 */
    ...
    INT_ID_RSVD98             =  98u,
    INT_ID_DFSDM1_FLT0        =  99u,                           /* DFSDM Filter1 Interrupt                              */
    INT_ID_DFSDM1_FLT1        = 100u,                           /* DFSDM Filter2 Interrupt                              */
    INT_ID_DFSDM1_FLT2        = 101u,                           /* DFSDM Filter3 Interrupt                              */
    INT_ID_DFSDM1_FLT3        = 102u,                           /* DFSDM Filter4 Interrupt                              */
    INT_ID_SDMMC2             = 103u,                           /* SDMMC2 global Interrupt                              */
    INT_ID_CAN3_TX            = 104u,                           /* CAN3 TX Interrupt                                    */
    INT_ID_CAN3_RX0           = 105u,                           /* CAN3 RX0 Interrupt                                   */
    INT_ID_CAN3_RX1           = 106u,                           /* CAN3 RX1 Interrupt                                   */
    INT_ID_CAN3_SCE           = 107u,                           /* CAN3 SCE Interrupt                                   */
    INT_ID_JPEG               = 108u,                           /* JPEG global Interrupt                                */
    INT_ID_MDIOS              = 109u                            /* MDIOS global Interrupt                               */
} BSP_INT_ID;
