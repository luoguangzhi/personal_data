...
*
*                   USER_LD1        Turns on user LED LD1
*                   USER_LD2        Turns on user LED LD2
*                   USER_LD3        Turns on user LED LD3
...
* Argument(s) : led    The ID of the LED to control.
*
*                   USER_LD1        Turns off user LED LD1
*                   USER_LD2        Turns off user LED LD2
*                   USER_LD3        Turns off user LED LD3
...
* Argument(s) : led    The ID of the LED to control.
*
*                   USER_LD1        Toggles user LED LD1
*                   USER_LD2        Toggles user LED LD2
*                   USER_LD3        Toggles user LED LD3
